const validationsForm = (name, value) => {
  ...
  if (name === "age" && !value.trim()) errors.age = "The age field is require";
  else if (name === "age" && value.trim()) errors.age = undefined;
  if (name === "age" && parseInt(value) < 18) errors.age = "The age >18";
